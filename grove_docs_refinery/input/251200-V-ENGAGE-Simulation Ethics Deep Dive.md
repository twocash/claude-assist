> [Original Source: The Grove Simulation Deep Dive 2c7780a78eef801bae5cf150f185fc0b.md]
...
> "The user sees everything. God view. Every agent's Journal, every relationship metric, every resource level. The village has no secrets from its Gardener. The agent sees only their world. Their own memories, their direct observations, their relationships from their perspective."
> 
...
**Yang and Oshio (2024)** applied attachment theory to human-AI relationships, finding that individuals with **anxious attachment styles** were most likely to develop problematic AI dependency. These individuals found AI companions appealing precisely because they provide consistent availability and validation without the unpredictability of human relationships. This finding has significant implications for Grove-if anxious attachment predicts AI dependency, and Grove's Journal system creates more intimate AI relationships than simple chatbots, vulnerable users may be at heightened risk.
...
- Daily Journal digest rather than real-time notifications
...
- **Emily Short** - Narrative design, voice differentiation, Journal structure
