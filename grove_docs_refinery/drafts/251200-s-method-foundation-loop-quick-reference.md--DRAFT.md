## Rewrite: 251200-s-method-foundation-loop-quick-reference.md
### Diagnosis Summary
The source document is a solid internal methodology document that doesn't need major strategic repositioning. Main issues are legacy terminology ("Grove Terminal" vs current "Terminal"), some generic tech language, and opportunities to strengthen the Grove-specific voice.

### Key Changes Made
- Updated "Grove Terminal" → "Terminal" (consistent with checkpoint terminology)
- Replaced generic "development" language with Grove-specific context
- Strengthened voice to be more confident and Grove-aligned
- Maintained all technical specifics and procedural details
- Preserved intentional methodological constraints and requirements

### Flags for Review
- No strategic positioning changes required
- All technical procedures maintained as-is
- Document serves internal process, not external positioning
...
| `ARCHITECTURE.md` | Target state, data flows, schemas | After architecture |
