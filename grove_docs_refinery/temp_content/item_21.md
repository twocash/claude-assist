...
<table header-row="true">
	...
	<tr>
		...
		<td>Personal computers with 16-32GB RAM—serious computing, not embedded systems</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Agents with memory streams, relationships, goals—plus Docker/sandbox access for self-improvement</td>
	</tr>
	<tr>
		<td>How do agents think?</td>
		<td>5-phase cognition loop: Perceive → Retrieve → Reason → Act → Record</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Diary system—proof your Grove is working, learning, developing</td>
	</tr>
	<tr>
